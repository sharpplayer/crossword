...
public class TableCellTabAction extends AbstractAction {
	...
	/** Editor component. */
	private ComplexCellEditor component;
	...
	public TableCellTabAction(final JTable table, final int newColumn, final boolean newForward,
		...
		originalAction = table.getActionMap().get(key);
		column = newColumn;
	...
	public final void actionPerformed(final ActionEvent e) {
		...
		if (table.getSelectedColumn() == column && table.isEditing()) {
			...
			if (KeyboardFocusManager.getCurrentKeyboardFocusManager().getFocusOwner().equals(limitComponent)) {
