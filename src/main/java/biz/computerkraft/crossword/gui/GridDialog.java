...
public class GridDialog extends JFrame implements CellUpdateListener, CellSelectListener {
    ...
    /** Logger. */
    private static final Logger LOGGER = LoggerFactory.getLogger(GridDialog.class);
    ...
    /** Database connection. */
    private transient DBConnection connection = new DBConnection();
    ...
    private transient Point2D lastOffset = new Point2D.Double(CELL_CENTRE, 0.0);
    ...
    /** Last cell selected. */
    private transient Cell lastSelected = null;
    ...
    public GridDialog() {
        ...
        JPanel wordPanel = setupWordList();
        JPanel versePanel = setupVersePanel(wordPanel);
        SpringUtilities.makeCompactGrid(versePanel, 1, 2, MARGIN, MARGIN, MARGIN, MARGIN);
        wordTabs.addTab("Words", wordPanel);
    }

    private JPanel setupVersePanel(JPanel wordPanel) {
        ...
        verseList.addListSelectionListener(e -> {
        ...
        addRefButton.addActionListener(e -> {
            ...
            for (Cell cell : currentCells) {
                ...
                if (clue.isPresent()) {
                    ...
                    Verse verse = verseList.getSelectedValue();
    ...
    private JPanel setupWordList() {
        ...
        wordList.setFont(new Font("Courier New", Font.BOLD, wordList.getFont()
                .getSize()));
    ...
    private void setupMenu() {
        ...
        publish.addActionListener(e -> createPdf());

        fileMenu.addSeparator();

        JMenuItem properties = new JMenuItem("Properties...");
        fileMenu.add(properties);
        properties.addActionListener(e -> propertyDialog.setVisible(true));
    ...
    public final void activatePuzzle(final Puzzle newPuzzle, final PropertyDialog properties, final File file) {
        ...
        for (ClueModel model : clues) {
            ...
            if (component instanceof JScrollPane) {
                Component view = ((JScrollPane) component).getViewport()
                        .getView();
     ...
     * (non-Javadoc)
     * 
     * @see biz.computerkraft.crossword.gui.CellUpdateListener#selectCell(biz. computerkraft.crossword.grid.Cell,
    ...
    public final void selectCell(final Cell cell, final Point2D offset) {
        ...
        addVerseButton.setEnabled(addRefButton.isEnabled() && (verseText.getText()
                .length() > 0));
        if (updateWordList()) {
            dirty = true;
        }
     ...
     * (non-Javadoc)
     * 
     * @see biz.computerkraft.crossword.gui.CellUpdateListener#addCellContent(biz. computerkraft.crossword.grid.Cell,
     * java.lang.String)
     */
    @Override
    ...
    private boolean updateWordList() {
        ...
        for (Cell indirectCell : crosswordGrid.getFirstIndirectSelection()) {
            if (indirectCell.isEmpty()) {
                ...
                word.append(indirectCell.getDisplayContents());
            }
        }
        if (wordListModel.setWordList(word.toString())) {
            verseModel.clear();
            verseText.setText("");
     ...
     * (non-Javadoc)
     * 
     * @see biz.computerkraft.crossword.gui.CellUpdateListener#clearCellContent(biz. computerkraft.crossword.grid.Cell)
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see biz.computerkraft.crossword.gui.CellUpdateListener#selectCellLeft(biz. computerkraft.crossword.grid.Cell)
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see biz.computerkraft.crossword.gui.CellUpdateListener#selectCellUp(biz. computerkraft.crossword.grid.Cell)
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see biz.computerkraft.crossword.gui.CellUpdateListener#selectCellRight(biz. computerkraft.crossword.grid.Cell)
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see biz.computerkraft.crossword.gui.CellUpdateListener#selectCellDown(biz. computerkraft.crossword.grid.Cell)
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see biz.computerkraft.crossword.gui.CellUpdateListener#cellMenuAction(biz. computerkraft.crossword.grid.Cell,
     * java.lang.String)
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see biz.computerkraft.crossword.gui.CellUpdateListener#populateCellMenu(biz. computerkraft.crossword.grid.Cell,
     * java.util.List)
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see biz.computerkraft.crossword.gui.CellUpdateListener#setWord(biz. computerkraft.crossword.db.Word)
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see biz.computerkraft.crossword.gui.CellUpdateListener#increaseSortLetter()
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see biz.computerkraft.crossword.gui.CellUpdateListener#decreaseSortLetter()
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see biz.computerkraft.crossword.gui.CellUpdateListener#selectCell(biz. computerkraft.crossword.grid.Cell, int)
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see biz.computerkraft.crossword.gui.CellUpdateListener#setVersesWithWord(biz. computerkraft.crossword.db.Word)
     */
    @Override
